...
export const mockUstawy: Ustawa[] = [
  {
    ...
    drukNumber: 'UD123',
    documentVersions: [
      { id: '1-1', version: '1.0', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '1-2', version: '1.1', date: new Date('2025-11-22'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach resortowych' },
      { id: '1-3', version: '2.0', date: new Date('2025-12-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '1-4', version: '2.1', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Przedstawiciele branży IT wyrażają obawy dotyczące kosztów wdrożenia nowych wymogów, szczególnie dla małych i średnich przedsiębiorstw. Szacuje się, że koszt dostosowania systemów może wynieść średnio 50-100 tys. zł dla MŚP.`,
  },
  {
    ...
    drukNumber: 'Druk 456',
    documentVersions: [
      { id: '2-1', version: '1.0', date: new Date('2025-09-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '2-2', version: '1.1', date: new Date('2025-09-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1940/text.pdf', description: 'Po konsultacjach' },
      { id: '2-3', version: '2.0', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '2-4', version: '2.1', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1940/text.pdf', description: 'Po I czytaniu w Sejmie' },
      { id: '2-5', version: '2.2', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po poprawkach komisji' },
    ],
...
Ustawa przewiduje system kar za brak dostosowania - do 10 000 zł miesięcznie za każdą niespełniającą wymogów stronę.`,
  },
  {
    ...
    documentVersions: [
      { id: '3-1', version: '0.1', date: new Date('2025-12-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja robocza' },
    ],
...
Stworzenie centralnej platformy będzie wymagało znaczących nakładów finansowych (szacunkowo 25-40 mln zł) oraz integracji z wieloma istniejącymi systemami informatycznymi administracji.`,
  },
  {
    ...
    drukNumber: 'UD789',
    documentVersions: [
      { id: '4-1', version: '1.0', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '4-2', version: '1.1', date: new Date('2025-11-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
      { id: '4-3', version: '1.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Eksperci ds. prywatności zwracają uwagę na ryzyko koncentracji danych osobowych w jednym systemie. Konieczne są dodatkowe gwarancje ochrony przed nieuprawnionym dostępem.`,
  },
  {
    ...
    drukNumber: 'Druk 234',
    documentVersions: [
      { id: '5-1', version: '1.0', date: new Date('2025-06-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '5-2', version: '2.0', date: new Date('2025-08-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach' },
      { id: '5-3', version: '3.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja sejmowa' },
      { id: '5-4', version: '3.1', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po poprawkach Senatu' },
      { id: '5-5', version: '4.0', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja uchwalona' },
    ],
    categories: ['technologia'],
...
Szacuje się, że wdrożenie AI w administracji przyniesie oszczędności rzędu 2-3 mld zł rocznie przy jednoczesnym skróceniu czasu rozpatrywania spraw o 40%.`,
  },
  {
    ...
    drukNumber: 'Druk 567',
    documentVersions: [
      { id: '6-1', version: '1.0', date: new Date('2025-08-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '6-2', version: '2.0', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '6-3', version: '2.1', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po III czytaniu w Sejmie' },
    ],
    categories: ['technologia', 'bezpieczenstwo'],
...
Ustawa ma zapewnić większe bezpieczeństwo danych osobowych przechowywanych przez banki, szpitale i urzędy. System wczesnego ostrzegania pozwoli na szybsze reagowanie na zagrożenia.`,
  },
  {
    ...
    drukNumber: 'Druk 789',
    documentVersions: [
      { id: '7-1', version: '1.0', date: new Date('2025-05-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '7-2', version: '2.0', date: new Date('2025-07-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach' },
      { id: '7-3', version: '3.0', date: new Date('2025-09-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja sejmowa' },
      { id: '7-4', version: '3.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '7-5', version: '3.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Do podpisu Prezydenta' },
    ],
    categories: ['technologia'],
...
Eksperci ds. bezpieczeństwa wyrażają obawy dotyczące możliwości manipulacji. Projekt zakłada rozbudowany system kontroli, ale część środowisk apeluje o ostrożność.`,
  },
  {
    ...
    drukNumber: 'UD456',
    documentVersions: [
      { id: '8-1', version: '1.0', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '8-2', version: '1.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach wewnętrznych' },
      { id: '8-3', version: '1.2', date: new Date('2025-11-28'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z analizą porównawczą UE' },
      { id: '8-4', version: '2.0', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
    categories: ['technologia'],
...
Pełne wdrożenie w ciągu 24 miesięcy od wejścia ustawy w życie.`,
  },
  {
    ...
    drukNumber: 'UD234',
    documentVersions: [
      { id: '9-1', version: '1.0', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '9-2', version: '1.1', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z branżą IT' },
      { id: '9-3', version: '1.2', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Dodano specyfikację API' },
      { id: '9-4', version: '2.0', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja po uzgodnieniach' },
      { id: '9-5', version: '2.1', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja robocza' },
    ],
    categories: ['technologia', 'biznes'],
...
System będzie zintegrowany z KRS, CEIDG, ZUS i US, co pozwoli na automatyczną weryfikację wykonawców bez konieczności załączania zaświadczeń.`,
  },
  {
    ...
    drukNumber: 'Druk 123',
    documentVersions: [
      { id: '10-1', version: '1.0', date: new Date('2025-04-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '10-2', version: '1.1', date: new Date('2025-05-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '10-3', version: '2.0', date: new Date('2025-07-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '10-4', version: '2.1', date: new Date('2025-09-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po pracach komisji' },
      { id: '10-5', version: '2.2', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja odrzucona' },
    ],
    categories: ['technologia', 'bezpieczenstwo'],
...
Ministerstwo rozważa softsza regulację skupioną na edukacji medialnej i wspieraniu fact-checkingu zamiast obowiązkowej moderacji treści.`,
  },
  {
    ...
    updatedAt: new Date('2025-12-06'),
    documentVersions: [
      { id: '11-1', version: '0.1', date: new Date('2025-12-02'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wstępny zarys koncepcji' },
      { id: '11-2', version: '0.2', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Rozszerzony projekt' },
    ],
...
Wszystkie zdigitalizowane zasoby będą bezpłatnie dostępne na platformie polona.pl oraz w nowym portalu kulturalnym.`,
  },
  {
    ...
    drukNumber: 'Druk 890',
    documentVersions: [
      { id: '12-1', version: '1.0', date: new Date('2025-07-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '12-2', version: '1.1', date: new Date('2025-07-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach NFZ' },
      { id: '12-3', version: '2.0', date: new Date('2025-08-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '12-4', version: '2.1', date: new Date('2025-09-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z raportem z pilotażu' },
      { id: '12-5', version: '3.0', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '12-6', version: '3.1', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po komisji sejmowej' },
    ],
...
Niektóre świadczenia wymagają badania fizykalnego i nie mogą być realizowane zdalnie (np. chirurgia, niektóre badania diagnostyczne).`,
  },
  {
    ...
    drukNumber: 'UD567',
    documentVersions: [
      { id: '13-1', version: '1.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '13-2', version: '1.1', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach ZNP' },
      { id: '13-3', version: '1.2', date: new Date('2025-11-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z podstawą programową' },
      { id: '13-4', version: '2.0', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
...
Związki nauczycielskie wyrażają obawy o tempo wdrożenia i brak wystarczającej liczby wykwalifikowanych kadr.`,
  },
  {
    ...
    drukNumber: 'Druk 345',
    documentVersions: [
      { id: '14-1', version: '1.0', date: new Date('2025-08-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '14-2', version: '1.1', date: new Date('2025-09-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach branżowych' },
      { id: '14-3', version: '2.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '14-4', version: '2.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '14-5', version: '2.2', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z poprawkami komisji' },
    ],
...
Planowana budowa sieci szybkich ładowarek wzdłuż głównych dróg (co 50 km). Budżet: 3 mld zł w ciągu 5 lat.`,
  },
  {
    ...
    drukNumber: 'Druk 678',
    documentVersions: [
      { id: '15-1', version: '1.0', date: new Date('2025-03-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '15-2', version: '1.1', date: new Date('2025-04-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po prekonsultacjach' },
      { id: '15-3', version: '2.0', date: new Date('2025-05-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '15-4', version: '3.0', date: new Date('2025-07-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '15-5', version: '3.1', date: new Date('2025-08-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '15-6', version: '3.2', date: new Date('2025-09-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '15-7', version: '4.0', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja uchwalona' },
    ],
...
System wchodzi w życie 1 stycznia 2026 roku.`,
  },
  {
    ...
    drukNumber: 'UD890',
    documentVersions: [
      { id: '16-1', version: '1.0', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '16-2', version: '1.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z analizą kosztów' },
      { id: '16-3', version: '1.2', date: new Date('2025-12-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach z MF' },
      { id: '16-4', version: '2.0', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Automatyczne naliczanie przez ZUS, bez konieczności składania wniosków (dla osób pobierających 500+).`,
  },
  {
    ...
    drukNumber: 'Druk 901',
    documentVersions: [
      { id: '17-1', version: '1.0', date: new Date('2025-09-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Propozycja rządowa' },
      { id: '17-2', version: '1.1', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po dialogu ze związkami' },
      { id: '17-3', version: '2.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja kompromisowa' },
      { id: '17-4', version: '2.1', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '17-5', version: '2.2', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '17-6', version: '3.0', date: new Date('2025-11-28'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja uchwalona' },
    ],
...
OPZZ postulował 4 800 zł, Lewiatan proponował 4 500 zł. Przyjęta kwota to kompromis.`,
  },
  {
    ...
    drukNumber: 'Druk 234',
    documentVersions: [
      { id: '18-1', version: '1.0', date: new Date('2025-07-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt poselski' },
      { id: '18-2', version: '1.1', date: new Date('2025-08-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z NGO' },
      { id: '18-3', version: '2.0', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '18-4', version: '2.1', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po komisji' },
      { id: '18-5', version: '2.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Przekazana do Senatu' },
    ],
    categories: ['srodowisko'],
...
Dodatkowe 100 mln zł rocznie na wsparcie schronisk i programy sterylizacji bezdomnych zwierząt.`,
  },
  {
    ...
    drukNumber: 'UD345',
    documentVersions: [
      { id: '19-1', version: '1.0', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '19-2', version: '1.1', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach KRIR' },
      { id: '19-3', version: '2.0', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
...
Źródła: budżet państwa + fundusze UE (WPR)`,
  },
  {
    ...
    drukNumber: 'UD678',
    documentVersions: [
      { id: '20-1', version: '1.0', date: new Date('2025-09-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '20-2', version: '1.1', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z raportem KNF' },
      { id: '20-3', version: '1.2', date: new Date('2025-10-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z branżą' },
      { id: '20-4', version: '2.0', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
      { id: '20-5', version: '2.1', date: new Date('2025-12-02'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Utworzenie Funduszu Rekompensat dla inwestorów poszkodowanych przez nieuczciwe praktyki (do 100 000 zł).`,
  },
  {
    ...
    updatedAt: new Date('2025-12-05'),
    documentVersions: [
      { id: '21-1', version: '0.1', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Założenia projektu' },
      { id: '21-2', version: '0.2', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Rozszerzony zarys' },
    ],
...
Firmy technologiczne wyrażają sprzeciw, argumentując, że podatek może zostać przerzucony na konsumentów w formie wyższych cen.`,
  },
  {
    ...
    drukNumber: 'Druk 567',
    documentVersions: [
      { id: '22-1', version: '1.0', date: new Date('2025-06-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '22-2', version: '1.1', date: new Date('2025-07-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach ze związkami' },
      { id: '22-3', version: '2.0', date: new Date('2025-08-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '22-4', version: '3.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '22-5', version: '3.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '22-6', version: '3.2', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Uchwalona przez Sejm' },
    ],
...
Źródła: budżet państwa, fundusze UE, opłaty od zakładów bukmacherskich (nowy cel podatkowy)`,
  },
  {
    ...
    drukNumber: 'UD901',
    documentVersions: [
      { id: '23-1', version: '1.0', date: new Date('2025-10-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '23-2', version: '1.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach branży' },
      { id: '23-3', version: '2.0', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
...
Obowiązkowe szkolenia ekologiczne dla przewodników i pilotów wycieczek.`,
  },
  {
    ...
    drukNumber: 'Druk 890',
    documentVersions: [
      { id: '24-1', version: '1.0', date: new Date('2025-05-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '24-2', version: '1.1', date: new Date('2025-06-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z URE' },
      { id: '24-3', version: '2.0', date: new Date('2025-07-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '24-4', version: '3.0', date: new Date('2025-09-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '24-5', version: '3.1', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '24-6', version: '3.2', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po komisji' },
      { id: '24-7', version: '3.3', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Przyjęta przez Senat' },
    ],
...
30% energii z OZE do 2030 roku`,
  },
  {
    ...
    drukNumber: 'UD123',
    documentVersions: [
      { id: '25-1', version: '1.0', date: new Date('2025-08-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '25-2', version: '1.1', date: new Date('2025-09-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z mapą stref' },
      { id: '25-3', version: '1.2', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z samorządami' },
      { id: '25-4', version: '2.0', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
      { id: '25-5', version: '2.1', date: new Date('2025-12-02'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Eliminacja smogu w 20 najbardziej zanieczyszczonych miastach`,
  },
  {
    ...
    drukNumber: 'UD456',
    documentVersions: [
      { id: '26-1', version: '1.0', date: new Date('2025-11-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '26-2', version: '1.1', date: new Date('2025-11-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z analizą lokalizacji' },
      { id: '26-3', version: '2.0', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
...
Pierwsze inwestycje w 50 miastach średniej wielkości, gdzie deficyt mieszkań jest największy.`,
  },
  {
    ...
    drukNumber: 'Druk 123',
    documentVersions: [
      { id: '27-1', version: '1.0', date: new Date('2025-07-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '27-2', version: '1.1', date: new Date('2025-08-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z deweloperami' },
      { id: '27-3', version: '2.0', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '27-4', version: '3.0', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '27-5', version: '3.1', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '27-6', version: '3.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po komisji' },
    ],
...
Przyspieszenie procesów inwestycyjnych o 40%`,
  },
  {
    ...
    drukNumber: 'Druk 456',
    documentVersions: [
      { id: '28-1', version: '1.0', date: new Date('2025-04-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '28-2', version: '1.1', date: new Date('2025-05-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z miastami' },
      { id: '28-3', version: '2.0', date: new Date('2025-06-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '28-4', version: '3.0', date: new Date('2025-08-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '28-5', version: '3.1', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '28-6', version: '3.2', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '28-7', version: '3.3', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Do podpisu Prezydenta' },
    ],
...
Program "Bezpieczny Przystanek": dofinansowanie 80% kosztów`,
  },
  {
    ...
    drukNumber: 'UD789',
    documentVersions: [
      { id: '29-1', version: '1.0', date: new Date('2025-06-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '29-2', version: '1.1', date: new Date('2025-07-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z harmonogramem budowy' },
      { id: '29-3', version: '1.2', date: new Date('2025-08-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z PKP' },
      { id: '29-4', version: '2.0', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach z UE' },
      { id: '29-5', version: '2.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z analizą finansową' },
      { id: '29-6', version: '2.2', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
Szacuje się, że inwestycja przyczyni się do wzrostu PKB o 0,5% rocznie i utworzenia 300 000 miejsc pracy.`,
  },
  {
    ...
    drukNumber: 'UD234',
    documentVersions: [
      { id: '30-1', version: '1.0', date: new Date('2025-11-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '30-2', version: '1.1', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach RPD' },
      { id: '30-3', version: '2.0', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
...
Do 4% globalnego obrotu platformy za poważne naruszenia (wzorem RODO).`,
  },
  {
    ...
    drukNumber: 'Druk 789',
    documentVersions: [
      { id: '31-1', version: '1.0', date: new Date('2025-08-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt obywatelski' },
      { id: '31-2', version: '1.1', date: new Date('2025-08-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach ze środowiskiem' },
      { id: '31-3', version: '2.0', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '31-4', version: '3.0', date: new Date('2025-10-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '31-5', version: '3.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '31-6', version: '3.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Uchwalona przez Sejm' },
    ],
...
Zatrudnienie 2000 certyfikowanych tłumaczy do 2028 roku`,
  },
  {
    ...
    drukNumber: 'Druk 345',
    documentVersions: [
      { id: '32-1', version: '1.0', date: new Date('2025-05-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '32-2', version: '1.1', date: new Date('2025-06-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach NIL' },
      { id: '32-3', version: '2.0', date: new Date('2025-07-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '32-4', version: '3.0', date: new Date('2025-09-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '32-5', version: '3.1', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '32-6', version: '3.2', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'W Senacie' },
    ],
    categories: ['zdrowie'],
...
Maksymalny czas oczekiwania na dokumentację: 5 dni roboczych (było: 30)`,
  },
  {
    ...
    drukNumber: 'Druk 567',
    documentVersions: [
      { id: '33-1', version: '1.0', date: new Date('2025-04-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '33-2', version: '1.1', date: new Date('2025-05-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po analizie AOTMiT' },
      { id: '33-3', version: '2.0', date: new Date('2025-06-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po negocjacjach cenowych' },
      { id: '33-4', version: '3.0', date: new Date('2025-08-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '33-5', version: '3.1', date: new Date('2025-09-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '33-6', version: '3.2', date: new Date('2025-10-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '33-7', version: '4.0', date: new Date('2025-11-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja uchwalona' },
    ],
    categories: ['zdrowie'],
...
Automatyczne włączanie leków dopuszczonych w procedurze centralnej EMA`,
  },
  {
    ...
    drukNumber: 'UD567',
    documentVersions: [
      { id: '34-1', version: '1.0', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '34-2', version: '1.1', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach KRASP' },
      { id: '34-3', version: '1.2', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach związków' },
      { id: '34-4', version: '2.0', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
    categories: ['edukacja'],
...
Cel: podwojenie liczby studentów zagranicznych do 2030 roku`,
  },
  {
    ...
    drukNumber: 'UD890',
    documentVersions: [
      { id: '35-1', version: '1.0', date: new Date('2025-09-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '35-2', version: '1.1', date: new Date('2025-10-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Ze strategią 2030' },
      { id: '35-3', version: '1.2', date: new Date('2025-10-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z NCN' },
      { id: '35-4', version: '2.0', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
      { id: '35-5', version: '2.1', date: new Date('2025-12-03'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
    categories: ['edukacja', 'technologia'],
...
Budowa 10 nowoczesnych centrów badawczych w modelu "science park"`,
  },
  {
    ...
    updatedAt: new Date('2025-12-05'),
    documentVersions: [
      { id: '36-1', version: '0.1', date: new Date('2025-11-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Założenia projektu' },
      { id: '36-2', version: '0.2', date: new Date('2025-12-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja robocza' },
    ],
    categories: ['kultura'],
...
Wzrost budżetu na ochronę zabytków o 100% do 1 mld zł rocznie`,
  },
  {
    ...
    drukNumber: 'Druk 678',
    documentVersions: [
      { id: '37-1', version: '1.0', date: new Date('2025-07-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '37-2', version: '1.1', date: new Date('2025-07-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach ze związkami' },
      { id: '37-3', version: '2.0', date: new Date('2025-08-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '37-4', version: '3.0', date: new Date('2025-10-10'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '37-5', version: '3.1', date: new Date('2025-11-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po I czytaniu' },
      { id: '37-6', version: '3.2', date: new Date('2025-12-04'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po II czytaniu' },
    ],
...
Koszt programu: 800 mln zł rocznie`,
  },
  {
    ...
    drukNumber: 'UD901',
    documentVersions: [
      { id: '38-1', version: '1.0', date: new Date('2025-10-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '38-2', version: '1.1', date: new Date('2025-11-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach branży' },
      { id: '38-3', version: '2.0', date: new Date('2025-12-06'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja do konsultacji' },
    ],
    categories: ['biznes'],
...
Szybsza ścieżka rozpatrywania skarg przez UOKiK (max. 30 dni)`,
  },
  {
    ...
    drukNumber: 'Druk 890',
    documentVersions: [
      { id: '39-1', version: '1.0', date: new Date('2025-03-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '39-2', version: '1.1', date: new Date('2025-04-20'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po transpozycji dyrektywy' },
      { id: '39-3', version: '2.0', date: new Date('2025-06-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach publicznych' },
      { id: '39-4', version: '3.0', date: new Date('2025-07-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja rządowa' },
      { id: '39-5', version: '3.1', date: new Date('2025-08-30'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Sejmie' },
      { id: '39-6', version: '3.2', date: new Date('2025-10-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po Senacie' },
      { id: '39-7', version: '4.0', date: new Date('2025-11-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Wersja uchwalona' },
    ],
...
Firmy >50 pracowników muszą utworzyć wewnętrzny kanał zgłaszania nieprawidłowości`,
  },
  {
    ...
    drukNumber: 'UD345',
    documentVersions: [
      { id: '40-1', version: '1.0', date: new Date('2025-08-25'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Projekt wyjściowy' },
      { id: '40-2', version: '1.1', date: new Date('2025-09-15'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Z raportem o rynku' },
      { id: '40-3', version: '1.2', date: new Date('2025-10-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po konsultacjach z platformami' },
      { id: '40-4', version: '2.0', date: new Date('2025-11-01'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
      { id: '40-5', version: '2.1', date: new Date('2025-12-02'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Aktualna wersja' },
    ],
...
• Utworzenie punktów pomocy cyfrowej w każdej gminie`,
    ...
    documentVersion: { id: '4-2', version: '1.1', date: new Date('2025-11-05'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uzgodnieniach' },
  },
  {
    id: '5',
    ustawaId: '1',
...
• Planowane przyjęcie przez rząd: styczeń 2025`,
    ...
    documentVersion: { id: '1-2', version: '1.1', date: new Date('2025-11-22'), url: 'https://api.sejm.gov.pl/eli/acts/DU/2024/1946/text.pdf', description: 'Po uwagach resortowych' },
    diff: {
